...
HD_PWD='C:/Users/REV/VivadoProjects/mtds_demo_1/mtds_demo_1.runs/design_1_PmodMTDS_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodMTDS_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodMTDS_0_0.tcl
